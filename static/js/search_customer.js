$(document).ready(function() {
    ...
    function fetchCustomers(searchTerm = '', showAll = false) {
        const $searchBtn = $('#searchBtn');
        const $spinner = $searchBtn.find('.loading-spinner');
                ...
                if (Array.isArray(data) && data.length > 0) {
                    data.forEach(function(customer) {
                        resultsContainer.append(`
                            <div class="list-group-item list-group-item-action customer-result"
                                 data-customer="${escapeHtml(customer)}">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span><i class="bi bi-person-circle me-2"></i>${escapeHtml(customer)}</span>
                    ...
                    if (!showAll && searchTerm.length > 2) {
            ...
            .fail(function() {
                ...
                $('#customerResults').html(`
                    <div class="list-group-item text-danger text-center">
                        <i class="bi bi-exclamation-triangle me-2"></i>Error loading customers
                    </div>
                `);
            })
            .always(function() {
    ...
    $(document).on('click', '.customer-result, .suggestion-item', function() {
